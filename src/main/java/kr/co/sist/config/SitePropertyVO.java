...
public class SitePropertyVO {
	...
	@Getter
	private String site_name,site_version,site_info,protocol,server_name,server_port,servlet_path,logo_img,upload_path;
	//변수들만 getter 함수를 갖는다.
	...
	private void setConfig()throws SQLException {
		...
		try {
			...
			String congigSql="select site_name,site_version,site_info,protocol,server_name,server_port,servlet_path,logo_img,upload_path from site_property";
			rs=stmt.executeQuery(congigSql);

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="naem속성이 중복 되어 있는 Form Control"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form name="frmGet" id="frmGet" action="duplicate_name_process.jsp" method="Get">
<ul>
...
<form name="frmPost" id="frmPost" action="duplicate_name_process.jsp">
<ul>
<li><label>radio</label>
	<input type="radio" name="gender" value="M"/>남자 | 
	<input type="radio" name="gender" value="F"/>여자  

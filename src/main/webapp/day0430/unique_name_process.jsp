...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="입력값을 받아서 처리하는 JSP-Process"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
//=> 사용자가 HTML Form Control에 입력한 값을 받는 일. => request 내장 객체가 한다.
//txt=123&pass=123&file=img_4.jpg&hid=5월+1일+근로자의+날+안쉼.&flag=flag&sel=오라클&ta=112sdfdfdfsadsdfvxc
...
String pass=request.getParameter("pass"); //<input type="password" name="password"
String file=request.getParameter("file"); //<input type="file" name="file" //commons file upload, apache file upload 등 file upload component를 사용해야 한다.
String hid=request.getParameter("hid"); //<input type="hidden" name="hide"
...
/*
if("POST".equals(request.getMethod() )){//요청방식이 POST 방식일때
	//한글 처리
...
<tbody>
<tr>
<%-- <td>type="text"</td><td><%=URLDecoder.decode(URLEncoder.encode(txt,"UTF-8"),"UTF-8") %></td>

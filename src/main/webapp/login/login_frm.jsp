...
<% System.out.println("loginFRamasjkldslajfklsdajfkldsajfklsa"); %>
<!doctype html>
<html lang="en" data-bs-theme="auto">
  <head>
	<c:import url="http://192.168.10.84/jsp_prj/common/jsp/external_file.jsp" />
    <meta charset="utf-8">
...
<main class="form-signin w-100 m-auto">
  <form id="loginFrm"  >
    ...
    <div class="form-floating">
      <input type="password"  class="form-control"  name="pass" id="pass" placeholder="비밀번호">
      <label for="floatingPassword">비밀번호</label>
    </div>
    <div id="loginFail"></div>
    <button class="btn btn-primary w-100 py-2" type="button" name="btnLogin" id="btnLogin">로그인</button>
    <p class="mt-5 mb-3 text-body-secondary">&copy; 내끄야 </p>
...
window.onload=function(){
	//document.getElementById("id").addEventListener("keydown",chkNull);

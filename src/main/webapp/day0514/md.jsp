...
<%@page import="javax.annotation.sql.DataSourceDefinition"%>
...
<c:import url="http://192.168.10.84/jsp_prj/common/jsp/header.jsp"/>
</header>
<main>
<div id="container">
<%
...
%>
sist_util.jar에서 제공한 SHA-256 : <%=temp %><br>
암호화된 문자열 : <%=cipher %><br>
복호화된 문자열 : <%=plain %><br>
</div>
</main>
<footer class="text-body-secondary py-5">
<c:import url="http://192.168.10.84/jsp_prj/common/jsp/footer.jsp"/>  
</footer>

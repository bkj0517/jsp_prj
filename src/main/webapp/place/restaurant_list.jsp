...
<%-- <%@ include file="../common/jsp/login_chk.jsp" %> --%><!-- 로그인안해도 됨 -->
...
<main>
<div id="container">
<div style="width:1200px; margin: 0 auto; height: 540px; width: 1200px">
<%
...
/* session.setAttribute("cntFlag", true);//초기화 (새로고침 카운트) */
%>
...
<br>
<a href="write_rest_frm.jsp"> 맛집 등록 하기</a>
</td>
</tr>
</c:if>
<%
...
<td><a href="rest_detail.jsp?num=${ restDTO.rest_num }&currentPage=${rDTO.currentPage}${searchQueryString}"><c:out value="${ restDTO.restaurant }"/></a></td>
...
<% PaginationDTO pDTO=new PaginationDTO(3,rDTO.getCurrentPage(),totalPage,
		"retaurant_list.jsp",rDTO.getField(), rDTO.getKeyword());
%>

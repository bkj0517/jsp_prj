...
<style type="text/css"> 
  ...
  #background { width:502px; height:353px; background: #FFFFFF url(http://192.168.10.84/html_prj/js0418/images/id_background.png) no-repeat; }
  ...
  <div id="background">
    ...
    <div id="inputDiv2">
      <form name="subFrm2">
        ...
        <span style="color:${color}" ><c:out value="${ msg }"/></span> 입니다.

...
<c:import url="http://192.168.10.92/jsp_prj/common/jsp/external_file.jsp"/>
...
<c:import url="http://192.168.10.92/jsp_prj/common/jsp/header.jsp"/>
</header>
<main>
<div id="container">
<div>
<h2>회원 리스트</h2>
<!-- role은 로그인 했을 때 관리자의 롤을 검색하여 session에 할당하여 필요한 곳에서 사용한다. -->
...
<c:import url="http://192.168.10.92/jsp_prj/common/jsp/footer.jsp"/>  
</footer>
